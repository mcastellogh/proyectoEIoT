...
\titulo{Sistema de monitoreo en tiempo real de temperaturas para refrigeradores críticos de salud} 
...
La medición a distancia continua y en tiempo real de estas temperaturas sumado a un sistema de alerta, aseguran las condiciones legales, minimizan los riesgos y garantizan la disponibilidad de hemoproductos y vacunas seguros en el momento y el lugar en que se precise. Este tabajo se enmarca en dos premisas fundamentales:
\begin{itemize}
