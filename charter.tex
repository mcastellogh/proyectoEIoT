...
Servidor: un hardware de servidor donde se instalará la dashboard. Deberá posser al menos 4 Gb de memoria RAM y capacidad de almacenamiento en disco rígido de al menos 30 Gb. 
...
\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Código\\ WBS\end{tabular}} & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Nombre \\ tarea\end{tabular}} & PC desktop & Laboratorio & Servidor & Sala reuniones & Teléfono móvil \\ \hline
 ...
 7.1&Verificación de requierimientos & 20  &  &5  &  &5\\ \hline
