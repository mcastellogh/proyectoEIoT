...
La medición a distancia continua y en tiempo real de estas temperaturas sumado a un sistema de alerta, aseguran las condiciones legales, minimizan los riesgos y garantizan la disponibilidad de hemoproductos seguros en el momento y el lugar en que se precise. Esto se enmarca en las políticas escenciales de la Secretaría de Salud Pública cuya misión es preservar la salud de la población, proponiendo un trabajo integrador para la construcción de opciones y entornos saludables.
...
Impulsor      & Roberto Collelo  & Secretaría de Salud Pública	&Sub Director de Bioingeniería\\ \hline
Responsable   & \authorname       & FIUBA        	& Alumno 	\\ \hline
Colaboradores & Roberto Collelo\newline
                Silvana Pereyra
                                  & Secretaría de Salud Pública\newline
                                  Dirección Centros de Salud	&Sub Director de Bioingeniería\newline %Jefa Droguería Central
 \\ \hline
...
Roberto Collelo, resulta de valiosa ayuda en el desarrollo del firmware de los sensores.
...
\item Requerimientos de hardware de los sensores
	...
	\item Filtro activo de la entrada de temperatura.
...
\item Requerimientos de las alarmas
	\begin{enumerate}
	\item Dispensación de las alarmas por efector/área.
	\item Notificaciones ante desplazamientos de la temperatura por encima del rango.
	\item Notificaciones ante desplazamientos de la temperatura por debajo del rango.
	\item Notificaciones ante desconexiones del dispositivo sensor.
	\item Notificaciones ante recupero de la conexión del dispositivo sensor.
	 \end{enumerate}	 
...
\item Grupo de tareas 1 BIBLIOGRAFIA POR EJEMPLO
	\begin{enumerate}
	\item Aprendizaje uso de Thingsboard
	\item Relevamiento
	\item Selección de efectores donde colocar los proptotipos
	\item seleccion de usuarios que harán las pruebas del prototipo
	\item charlas de sensibilización con los usuarios seleccionados
	
	\end{enumerate}
\item Desarrollo del circuito electrónico y PCB del sensor
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
	\end{enumerate}
\item Desarrollo del firmware del sensor
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
	...
	\end{enumerate}
\item Instalación y configuración del sitema operativo del servidor central
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
...
\item Instalación y configuración de la dashboard en el servidor central
	\begin{enumerate}
	\item Tarea 1 (tantas hs)
	\item Tarea 2 (tantas hs)
	\item Tarea 3 (tantas hs)
...
\item Gestión de las notificaciones
	\begin{enumerate}
	\item creación de canales en Telegram
	\item instalacion de app telegram en usuarios seleccionados para prueba
	\item Tarea 3 (tantas hs)
	\item Tarea 4 (tantas hs)
	\item Tarea 5 (tantas hs)
	\end{enumerate}		

\item Verificación de todas las fucionalidades
	\begin{enumerate}
	\item Verificación del cumplimiento de los requerimientos
	\item instalacion de app telegram en usuarios seleccionados para prueba
	\item Tarea 3 (tantas hs)
	\item Tarea 4 (tantas hs)
	\item Tarea 5 (tantas hs)
